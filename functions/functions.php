...
function getPro(){
    ...
    // VERY USEFUL/IMPORTANT - Change the "6" value if you want to change how many items are being shown in the page -BV //
    ...
    while($row_products=mysqli_fetch_array($run_products)){
        ...
        <div class='col-12 col-md-6 p-3 col-lg-4'>
            ...
            <div class='product'>
                ...
                <div class='text'>
                    ...
                    <p class='button' style='text-align:center;'>
                        ...
                        <a class='btn btn-warning-outline display-4' href='details.php?pro_id=$pro_id'>
        ...
        "; // KIND OF IMPORTANT? I only messed with one other part of this function, it's "<a class='btn btn-warning-outline display-4' href='details.php?pro_id=$pro_id'>" because I wanted the button to look better -BV //
